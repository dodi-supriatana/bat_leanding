                ...
                <div class="row">
                    <div class="col-md-5 col-md-offset-1 animated" data-animation="fadeInUp" data-animation-delay="300">
                        ...
                        <div class="contact-form">
                            <!-- Form Begins -->
                            <form role="form" name="contactform" class="form-horizontal" id="contactform" method="post" action="http://zozothemes.com/html/layer/new-variants/image-bg/demo3/process.php">
                                <!-- Field 1 -->		
